            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-[4vw] md:p-[2vw]">
                    ...
                    >
                        ...
                        {/* Footer / Details */}
                        <div 
                            className="flex-1 min-h-0 p-[8vw] md:p-[2vw] bg-bg-primary overflow-y-auto overscroll-contain"
                            data-lenis-prevent
                        >
                                ...
                                <div className="max-w-2xl">
                                    ...
                                    <div className="flex flex-wrap gap-[2vw] md:gap-[0.5vw]">
                                        ...
                                        {project.techStack?.map((tech, i) => (
                                            <span key={i} className="px-[3vw] py-[1vw] md:px-[0.75vw] md:py-[0.25vw] rounded-full border border-fg-primary/20 text-[3vw] md:text-[0.8vw] font-mono bg-fg-primary/5 text-fg-secondary">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
